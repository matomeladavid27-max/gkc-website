...
title: About
layout: default
source: .meta/purpose.md, coach/.meta/purpose.md
...
Coach Banele's approach rests on four principles:

- **Every keeper deserves specialised training** — not just the ones at elite academies.
- **Goalkeeping is mental and physical** — confidence is trained, not given.
- **Fundamentals first, always** — consistent repetition combined with game-realistic scenarios.
- **Community drives development** — keepers who train together push each other further.
